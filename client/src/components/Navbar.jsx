                    ...
                    {token ? (
                        <>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-5 rounded-lg transition shadow-sm text-center"
                            >
                                Logout
                            </button>
                        </>
